import{f as l,j as e,aa as H,a1 as G,y as se,ab as U,$ as ae,ac as le,S as oe,ad as re,ae as ie,a0 as ne,af as ce,ag as de}from"./ui-Lh8lZkmh.js";import{E as xe}from"./pdf-ur72CjQZ.js";const k=r=>r.toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),x={pequena:{label:"Geladeira 70x30",detail:"7 x 3 cm",className:"w-[420px] h-[180px]",pdf:[70,30]},media:{label:"Prateleira 70x30",detail:"7 x 3 cm",className:"w-[420px] h-[180px]",pdf:[70,30]},grande:{label:"Destaque 70x30",detail:"7 x 3 cm",className:"w-[420px] h-[180px]",pdf:[70,30]},extra:{label:"Promo 70x30",detail:"7 x 3 cm",className:"w-[420px] h-[180px]",pdf:[70,30]}},f={simples:{title:"Simples",subtitle:"Padrão",icon:H},promocao:{title:"Promoção",subtitle:"Destaque",icon:oe},geladeira:{title:"Geladeira",subtitle:"Letra grande",icon:le},a4:{title:"Grande (A4)",subtitle:"Cartaz",icon:ae}};function ge({products:r}){var M;const[i,w]=l.useState("produto"),[j,V]=l.useState(""),[C,S]=l.useState(((M=r[0])==null?void 0:M.id)||""),[L,z]=l.useState(""),[P,$]=l.useState(""),[c,N]=l.useState("CERVEJA GELADA"),[J,A]=l.useState("simples"),[p,E]=l.useState("pequena"),[Q,R]=l.useState(!0),[W,T]=l.useState(!0),[_,D]=l.useState(!1),[m,h]=l.useState(1),[F,B]=l.useState(null),[q,O]=l.useState([]),Z=l.useRef(null),K=l.useMemo(()=>{const t=j.trim().toLowerCase();return t?r.filter(a=>a.name.toLowerCase().includes(t)||a.category.toLowerCase().includes(t)).slice(0,12):r.slice(0,10)},[r,j]),n=r.find(t=>t.id===C)||r[0],u=i==="produto"?(n==null?void 0:n.price)||0:Number(P.replace(",","."))||0,g=i==="produto"?(n==null?void 0:n.name)||"Produto":L.trim()||"PROMOÇÃO DO DIA";i==="produto"&&n!=null&&n.category;const I=t=>{var o;const a=(o=t.target.files)==null?void 0:o[0];if(!a)return;const s=new FileReader;s.onload=()=>B(String(s.result)),s.readAsDataURL(a)},X=()=>{z(""),$(""),N("CERVEJA GELADA"),A("simples"),E("pequena"),R(!0),T(!0),D(!1),h(1),B(null)},v=t=>{const a=new Date().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});O(s=>[`${a} • ${t}: ${g} ${k(u)}`,...s].slice(0,8))},Y=(t=!1)=>{const[a,s]=x[p].pdf,o=t?{width:`${a}mm`,height:`${s}mm`,borderRadius:"0",boxShadow:"none"}:void 0;return e.jsxs("div",{className:`${t?"":x[p].className} relative overflow-hidden bg-white shadow-2xl flex flex-col items-center justify-center text-center px-2`,style:o,children:[e.jsxs("div",{className:"absolute inset-0 opacity-90 pointer-events-none",children:[e.jsx("span",{className:"absolute left-[6%] top-[8%] w-2 h-2 rounded-full bg-black"}),e.jsx("span",{className:"absolute right-[9%] top-[13%] w-1.5 h-1.5 rounded-full bg-black"}),e.jsx("span",{className:"absolute left-[13%] bottom-[11%] w-1.5 h-1.5 rounded-full bg-black"}),e.jsx("span",{className:"absolute right-[18%] bottom-[8%] w-2 h-2 rounded-full bg-black"}),e.jsx("span",{className:"absolute left-[48%] top-[36%] w-[36%] h-[3px] rounded-full bg-yellow-400 -rotate-2"})]}),e.jsxs("div",{className:"relative z-10 w-full leading-none",children:[e.jsxs("div",{className:"font-black uppercase tracking-tight text-[17px] sm:text-[18px] graffiti-title flex justify-center gap-1",children:[e.jsx("span",{className:"text-sky-400",children:"PIT"}),e.jsx("span",{className:"text-yellow-400",children:"STOP"}),e.jsx("span",{className:"text-purple-500",children:"COHAB"})]}),c&&e.jsx("div",{className:"mt-1 font-black uppercase italic text-[8px] tracking-wide text-black graffiti-small truncate",children:c}),e.jsx("h2",{className:"mt-1 font-black uppercase text-[26px] leading-none text-lime-400 graffiti-product truncate",children:g}),e.jsxs("div",{className:"mt-0 flex items-end justify-center gap-2 font-black leading-none",children:[e.jsx("span",{className:"text-[17px] text-purple-500 graffiti-price-symbol mb-1",children:"R$"}),e.jsx("span",{className:"text-[42px] text-pink-500 graffiti-price",children:u.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})})]})]})]})},ee=()=>{v("Impressão");const[t,a]=x[p].pdf,s=u.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),o=g.toUpperCase(),b=c.toUpperCase(),d=`
      <!doctype html>
      <html>
        <head>
          <meta charset="utf-8" />
